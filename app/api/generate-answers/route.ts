  ...
  if (agent.active === true) {
    ...
    const supportAgent = new Agent<Ticket>({
      ...
      instructions: [
        ...
        agent.personality,
        'Here is your memory composed of previous interactions:',
        'Memory explanation: This is a collection of past customer tickets and your responses. Each entry contains the options you previously generated for a given ticket and the human preference (the selected or modified choice by the human supervisor). Use this to learn from past decisions and provide more aligned responses.',
        'Memory data:',
